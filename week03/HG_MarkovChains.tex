...
is satisfied by a bounded sequence $\{ u_n\}$ of real numbers, then $\exists \mathrm{lim}_{n\to \infty} u_n, \exists \mathrm{lim}_{n\to -\infty} u_n$. Furthermore, if
...
\begin{theorem}
\textbf{Corollary1}. Let $X_t$ ergodic Markov chain, i.e. irreducible, recurrent, aperiodic. Then
